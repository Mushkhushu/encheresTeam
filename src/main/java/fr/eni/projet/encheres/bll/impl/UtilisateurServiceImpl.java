...
//les constructeurs
	...
	@Override
	public void updateUser(Utilisateur utilisateur, String mdpNouveau) {
		if (!(mdpNouveau.isEmpty() || mdpNouveau == null)) {
	...
	public List<Utilisateur> getUsersArticlesEnCours() {
		return utilisateurDAO.getUsersArticlesEnCours();
	}
...
// METHODES DE VALIDATION DE LA BO -------------------------------------------------------
	...
	public Utilisateur getUserByPseudo(String pseudo) {
		Utilisateur utilisateur = utilisateurDAO.getUserByPseudo(pseudo);
